...
def parse_frontmatter(path: Path) -> dict:
    ...
    try:
        with open(path, encoding="utf-8") as f:
            ...
            # ⚡ Bolt: Lazily parse frontmatter to prevent reading the entire file
            # into memory. This optimization reduces latency and memory footprint
            # when handling large messages with extensive bodies.
            parsed_meta = {}
            closed = False
            for line in f:
                if line.strip() == "---":
