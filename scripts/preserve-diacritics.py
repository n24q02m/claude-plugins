...
def _strip_diacritics(s: str) -> str:
    ...
    if _COMBINING_TABLE is None:
        # Optimization: Pre-compute translation table and apply via str.translate to
        # reduce Python loop overhead in C. Done lazily to avoid ~150ms module startup penalty.
